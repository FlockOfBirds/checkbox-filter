...
const widgetConfig = {
    ...
    output: {
        ...
        filename: `src/com/mendix/widget/custom/checkboxfilter/${widgetName}.js`,
        libraryTarget: "umd"
    },
    resolve: {
        extensions: [ ".ts", ".js" ],
    ...
    plugins: [
        ...
        new ExtractTextPlugin({ filename: `./src/com/mendix/widget/custom/checkboxfilter/ui/${widgetName}.css` }),
